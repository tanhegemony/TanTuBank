                        ...
                        <form action="${pageContext.request.contextPath}/resultLoanCalculation" method="post">
                            <div class="form-group">
                                ...
                                <div class="input-group mb-3">
                                    <input type="number" class="form-control" placeholder="Bạn muốn vay bao nhiêu?" 
                                           name="loanMoney" id="loanMoney" value="${loanMoney}" required>
                    ...
                    <div class="col">
                        <table class="table table-bordered table-responsive-sm">
                            ...
                            <tr class="contentTable">
                                ...
                                <td class="text-right"><fmt:formatNumber type="number" value="${loanMoney}"/></td>
