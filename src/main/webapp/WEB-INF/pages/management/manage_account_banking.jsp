...
<html >
    ...
    <head>
        ...
        <title>Quản lý tài khoản ngân hàng -- <c:if test="${nav == 'managePaymentBankAccount'}">Tài khoản thanh toán</c:if>
            ...
            <c:if test="${nav == 'manageExternalBankAccount'}">Tài khoản liên ngân hàng</c:if></title>
            <!-- google font -->
                                    ...
                                    <div class="col">
                                        <table class="table table-striped table-responsive text-center">
                                            ...
                                            <c:if test="${bankAccounts.content.size() <= 0 || bankAccounts.content == null}">
                                                <tr>
                                                    <td colspan="7"><h4 style="font-weight: bolder;color:red; ">Không tồn tại tài khoản ngân hàng nào</h4></td>
                                                </tr>
                                            </c:if>
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td>
                                                            <c:if test="${ba.bankAccountStatus == 'ACTIVE'}">
                                                                <button onclick="location.href='${pageContext.request.contextPath}/management/changeBankAccountStatus/${ba.id}/LOCK'" class="btn btn-danger"><i class="fas fa-lock"></i> Lock</button>
                                                                <button class="btn btn-secondary"><i class="fas fa-file-edit"></i> Edit</button>
                                                            </c:if>
                                                            <c:if test="${ba.bankAccountStatus == 'UNACTIVE'}">
                                                                <button class="btn activeButton"><i class="fas fa-circle"></i> Active</button>
                                                                <button class="btn btn-dark"><i class="fas fa-trash-alt"></i> Delete</button>
                                                            </c:if>
                                                            <c:if test="${ba.bankAccountStatus == 'LOCK'}">
                                                                <button class="btn btn-primary"><i class="fas fa-lock-open"></i> Unlock</button>
                                                                <button class="btn btn-dark"><i class="fas fa-trash-alt"></i> Delete</button>
                                                            </c:if>
                                                        </td>
                                                    </tr>
